        ...
        if (strlen($nimi)>25 || !preg_match("/^[a-z0-9]((\.|_)?[a-z0-9]+)+@([a-z0-9]+(\.|-)?)+[a-z0-9]\.[a-z]{2,}$/", strtolower($email)) || strlen($sonum)>500 ) {
            ...
            if ($_POST['kood']==$_SESSION['captchatekst']) {
                ...
                if(mail($to, $subject, $message, $from)){
                    ...
                    echo "<meta http-equiv=\"refresh\" content=\"2;URL='yl7_2.php'\">";
                    exit();
                } else {
...
<form action="" method="post">
    Teie nimi:<br>
    <input name="nimi" type="text" value="<?php echo $vnimi; ?>">
    <br>
    Teie email:<br>
    <input name="email" type="text" value="<?php echo $vemail; ?>">
    <br>
    Sõnum:<br>
    <textarea cols="30" rows="10" name="sonum"><?php echo $vsonum; ?></textarea>
    <br>
    <img src="yl7_captcha.php"><br>
    Sisesta kood pildilt:<br>
    <input name="kood" type="text">
    <br>
