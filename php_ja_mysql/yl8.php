...
// vajab config.php-ed, andmebaas on siia lisatud, sest seal on teiste ylesannete jaoks teine andmebaas
include('config.php');
$andmebaas = 'csv_db 10';
$yhendus = mysqli_connect($db_server, $db_kasutaja, $db_salasona, $andmebaas);
if (!$yhendus) {
